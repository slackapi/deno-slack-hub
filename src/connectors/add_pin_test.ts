...
Deno.test("AddPin generates valid FunctionManifest", () => {assertEquals(AddPin.definition.callback_id, "slack#/functions/add_pin");
...
Deno.test("AddPin can be used as a Slack function in a workflow step", () => {const testWorkflow = DefineWorkflow({callback_id: "test_AddPin_slack_function", 
title: "Test AddPin", 
description: "This is a generated test to test AddPin"});
testWorkflow.addStep(AddPin, {channel_id: "test",
message: "test"});
