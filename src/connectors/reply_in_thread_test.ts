...
Deno.test("ReplyInThread generates valid FunctionManifest", () => {assertEquals(ReplyInThread.definition.callback_id, "slack#/functions/reply_in_thread");
const expected: ManifestFunctionSchema = {source_file: "",
title: "Reply in thread",
description: "Send a message in a thread",
input_parameters: {properties: {message_context: {type: SlackTypes.message_context,
...
title: "Add a reply"},
reply_broadcast: {type: SchemaTypes.boolean,
description: "Also send to conversation",
title: "Also send to conversation"},
metadata: {type: SchemaTypes.object,
...
output_parameters: {properties: {message_context: {type: SlackTypes.message_context,
...
Deno.test("ReplyInThread can be used as a Slack function in a workflow step", () => {const testWorkflow = DefineWorkflow({callback_id: "test_ReplyInThread_slack_function", 
title: "Test ReplyInThread", 
description: "This is a generated test to test ReplyInThread"});
testWorkflow.addStep(ReplyInThread, {message_context: "test",
message: "test"});
const actual = testWorkflow.steps[0].export();

assertEquals(actual.function_id, "slack#/functions/reply_in_thread");
assertEquals(actual.inputs, {message_context: "test",
message: "test"});});

Deno.test("All outputs of Slack function ReplyInThread should exist", () => {const testWorkflow = DefineWorkflow({callback_id: "test_ReplyInThread_slack_function", 
title: "Test ReplyInThread", 
description: "This is a generated test to test ReplyInThread"});
const step = testWorkflow.addStep(ReplyInThread, {message_context: "test",
message: "test"});
