...
Deno.test("CreateUsergroup generates valid FunctionManifest", () => {assertEquals(CreateUsergroup.definition.callback_id, "slack#/functions/create_usergroup");
...
Deno.test("CreateUsergroup can be used as a Slack function in a workflow step", () => {const testWorkflow = DefineWorkflow({callback_id: "test_CreateUsergroup_slack_function", 
title: "Test CreateUsergroup", 
description: "This is a generated test to test CreateUsergroup"});
testWorkflow.addStep(CreateUsergroup, {usergroup_handle: "test",
usergroup_name: "test"});
const actual = testWorkflow.steps[0].export();

assertEquals(actual.function_id, "slack#/functions/create_usergroup");
assertEquals(actual.inputs, {usergroup_handle: "test",
usergroup_name: "test"});});

Deno.test("All outputs of Slack function CreateUsergroup should exist", () => {const testWorkflow = DefineWorkflow({callback_id: "test_CreateUsergroup_slack_function", 
title: "Test CreateUsergroup", 
description: "This is a generated test to test CreateUsergroup"});
const step = testWorkflow.addStep(CreateUsergroup, {usergroup_handle: "test",
usergroup_name: "test"});
