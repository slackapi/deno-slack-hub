...
Deno.test("RemoveUserFromUsergroup generates valid FunctionManifest", () => {assertEquals(RemoveUserFromUsergroup.definition.callback_id, "slack#/functions/remove_user_from_usergroup");
...
Deno.test("RemoveUserFromUsergroup can be used as a Slack function in a workflow step", () => {const testWorkflow = DefineWorkflow({callback_id: "test_RemoveUserFromUsergroup_slack_function", 
...
assertEquals(actual.function_id, "slack#/functions/remove_user_from_usergroup");
assertEquals(actual.inputs, {usergroup_id: "test",
user_ids: "test"});});

Deno.test("All outputs of Slack function RemoveUserFromUsergroup should exist", () => {const testWorkflow = DefineWorkflow({callback_id: "test_RemoveUserFromUsergroup_slack_function", 
title: "Test RemoveUserFromUsergroup", 
description: "This is a generated test to test RemoveUserFromUsergroup"});
const step = testWorkflow.addStep(RemoveUserFromUsergroup, {usergroup_id: "test",
user_ids: "test"});
