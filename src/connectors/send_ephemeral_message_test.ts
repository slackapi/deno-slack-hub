...
Deno.test("SendEphemeralMessage generates valid FunctionManifest", () => {assertEquals(SendEphemeralMessage.definition.callback_id, "slack#/functions/send_ephemeral_message");
...
Deno.test("SendEphemeralMessage can be used as a Slack function in a workflow step", () => {const testWorkflow = DefineWorkflow({callback_id: "test_SendEphemeralMessage_slack_function", 
title: "Test SendEphemeralMessage", 
description: "This is a generated test to test SendEphemeralMessage"});
testWorkflow.addStep(SendEphemeralMessage, {channel_id: "test",
user_id: "test",
message: "test"});
...
Deno.test("All outputs of Slack function SendEphemeralMessage should exist", () => {const testWorkflow = DefineWorkflow({callback_id: "test_SendEphemeralMessage_slack_function", 
title: "Test SendEphemeralMessage", 
description: "This is a generated test to test SendEphemeralMessage"});
const step = testWorkflow.addStep(SendEphemeralMessage, {channel_id: "test",
user_id: "test",
message: "test"});
