...
This project generates the contents of the [`src`](../src/) folder using the
scripts located in the [`scripts`](../scripts/) folder (more info in
...
the [`src`](../src/) folder. Instead we highly encourage contributions to the
[`scripts`](../scripts/) folder which indirectly affect the contents of
[`src`](../src/).
